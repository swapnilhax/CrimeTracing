...
include('header.php');
	...
	if(!empty($_POST["search"]["date"])) {			
		...
		$queryCondition .= "WHERE n_date BETWEEN '$fiy-$fim-$fid' AND '" . $date_todate . "'";
	}

	$sql = "SELECT * from notice " . $queryCondition . " ORDER BY n_date desc";
...
<html>
    ...
    <div class="demo-content">
		...
		<h2 align="center" class="title_with_link">Notice</h2>
		<br>
...
<table class="table-content ">
        ...
        <tr>
          ...
          <th width="30%"><span>Subject</span></th>
          <th width="20%"><span>Date</span></th>          
          <th width="40%"><span> Message</span></th>	  
