...
include('header.php');
	...
	$sql = "SELECT * from e_challan " . $queryCondition . " ORDER BY date desc";
...
<html>
    ...
    <div class="demo-content">
		...
		<br>
<a href="challanexport.php"> Export Data to Excel</a>
...
<table class="table-content ">
        ...
        <tr>
          ...
          <th width="50%"><span>Vehical No</span></th>          
          <th width="20%"><span>Violation</span></th>	  
          <th width="20%"><span>Fine</span></th>
           <th width="20%"><span>Location</span></th>
            <th width="20%"><span>District</span></th>
             <th width="20%"><span>Offence Time</span></th>
	...
	?>
        <tr>
			...
			<td><?php echo $row["e_vehicalno"]; ?></td>
			<td><?php echo $row["e_violation"]; ?></td>
			<td><?php echo $row["e_fine"]; ?></td>
			<td><?php echo $row["e_location"]; ?></td>
			<td><?php echo $row["e_district"]; ?></td>
			<td><?php echo $row["e_offencetime"]; ?></td>
