 ...
 <!-- RD Google Map-->
     <!--  <section class="section section-fluid">
      ...
      <section class="section section-sm section-last bg-default text-left">
        <div class="container">
          <form method="post" enctype="multipart/form-data" action="unidentified-insert.php">
            <div class="row row-14 gutters-14">
              
              <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-your-name-2" type="text" name="u_deathtype" data-constraints="@Required">
                  <label class="form-label" for="contact-your-name-2">Death Type</label>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-your-name-2" type="text" name="u_date" data-constraints="@Required">
                  <label class="form-label" for="contact-your-name-2">Date</label>
                </div>
              </div>
               <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-your-name-2" type="text" name="u_location" data-constraints="@Required">
                  <label class="form-label" for="contact-your-name-2">Location</label>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-your-name-2" type="text" name="u_po" data-constraints="@Required">
                  <label class="form-label" for="contact-your-name-2">Police Station</label>
                </div>
              </div>
               <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-your-name-2" type="text" name="u_district" data-constraints="@Required">
                  <label class="form-label" for="contact-your-name-2">District</label>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-your-name-2" type="text" name="u_status" data-constraints="@Required">
