...
include('header.php');
	...
	$sql = "SELECT * from arrested " . $queryCondition . " ORDER BY date desc";
	$result = mysqli_query($conn,$sql);
?>

<html>
	<head>
    <title>Arrested Person</title>		
    ...
    <div class="demo-content">
		...
		<h2 align="center" class="title_with_link">Arrested Person</h2>
		<br>
<a href="arrestedexport.php"> Export Data to Excel</a>
<br>
...
<table class="table-content ">
        ...
        <tr>
          ...
          <th width="50%"><span>Location</span></th>          
          <th width="20%"><span>Crime Type</span></th>	
          <th width="40%"><span>Time Of Arrest</span></th>	  
          <th width="20%"><span>image</span></th>
        </tr>
      </thead>
    <tbody>
	<?php
	...
	?>
        <tr>
			...
			<td><?php echo $row["a_crimetype"]; ?></td>
			<td><?php echo $row["a_toa"]; ?></td>
