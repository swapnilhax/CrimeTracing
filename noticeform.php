     ...
     <!--  <section class="section section-fluid">
      ...
      <section class="section section-sm section-last bg-default text-left">
        <div class="container">
         ...
         <form method="post" enctype="multipart/form-data" action="notice-insert.php">
            <div class="row row-14 gutters-14">
              <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-your-name-2" type="text" name="n_subject" data-constraints="@Required">
                  <label class="form-label" for="contact-your-name-2">Subject</label>
                </div>
              </div>
               <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-your-name-2" type="text" name="n_date" data-constraints="@Required">
             ...
             <!--  <div class="col-md-4">
              ...
              <div class="col-12">
                <div class="form-wrap">
                  ...
                  <textarea class="form-input textarea-lg" id="contact-message-2" name="n_message" data-constraints="@Required"></textarea>
                </div>
              </div>
