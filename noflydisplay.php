...
include('header.php');
	...
	$sql = "SELECT * from no_fly " . $queryCondition . " ORDER BY date desc";
...
<table class="table-content ">
        ...
        <tr>
          ...
          <th width="40%"><span>Crime Type</span></th>
	...
	?>
        <tr>
			...
			<td><?php echo $row["n_location"]; ?></td>
			<td><?php echo $row["n_district"]; ?></td>
			<td><?php echo $row["n_crimetype"]; ?></td>
			<td><?php echo $row["n_po"]; ?></td>
