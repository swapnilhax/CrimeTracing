 ...
 <!-- RD Google Map-->
     <!--  <section class="section section-fluid">
      ...
      <section class="section section-sm section-last bg-default text-left">
        <div class="container">
          <form method="post" enctype="multipart/form-data" action="nofly-insert.php">
            <div class="row row-14 gutters-14">
              <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-your-name-2" type="text" name="n_name" data-constraints="@Required">
                  <label class="form-label" for="contact-your-name-2"> Name</label>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-your-name-2" type="text" name="n_location" data-constraints="@Required">
                  <label class="form-label" for="contact-your-name-2"> Location</label>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-your-name-2" type="text" name="n_district" data-constraints="@Required">
            ...
            <!--   <div class="col-md-4">
              ...
              <div class="col-12">
                <div class="form-wrap">
                  <label class="form-label" for="contact-message-2">CrimeType</label>
                  <textarea class="form-input textarea-lg" id="contact-message-2" name="n_crimetype" data-constraints="@Required"></textarea>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-your-name-2" type="text" name="n_po" data-constraints="@Required">
