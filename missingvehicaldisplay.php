...
include('header.php');
	...
	$sql = "SELECT * from misingvehical " . $queryCondition . " ORDER BY date desc";
...
<table class="table-content ">
        ...
        <tr>
          ...
          <th width="50%"><span>Company</span></th>          
          <th width="20%"><span>Licence</span></th>	  
	...
	?>
        <tr>
			...
			<td><?php echo $row["v_firno"]; ?></td>
			<td><?php echo $row["v_policestation"]; ?></td>
