     ...
     <!--  <section class="section section-fluid">
      ...
      <section class="section section-sm section-last bg-default text-left">
        <div class="container">
         ...
         <form method="post" enctype="multipart/form-data" action="challan-insert.php">
            <div class="row row-14 gutters-14">
              <div class="col-md-4">
               ...
               <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-phone-2" type="text" name="e_vehicalno" data-constraints="@Numeric">
              ...
              <!-- <div class="col-md-4">
               ...
               <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-your-name-2" type="text" name="e_violation" data-constraints="@Required">
                  <label class="form-label" for="contact-your-name-2">Violation</label>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-phone-2" type="text" name="e_fine" data-constraints="@Numeric">
                  <label class="form-label" for="contact-phone-2">Fine</label>
                </div>
              </div>
               <div class="col-md-4">
                <div class="form-wrap">
               ...
               <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" id="contact-phone-2" type="text" name="e_offencetime" data-constraints="@Numeric">
                  <label class="form-label" for="contact-phone-2">Offence Time</label>
                </div>
              </div>
             <!--  <div class="col-12">
                <div class="form-wrap">
